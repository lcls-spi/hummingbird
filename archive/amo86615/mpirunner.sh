...
`which mpirun` -v -tag-output -H daq-amo-mon02,daq-amo-mon03,daq-amo-mon04 --report-pid .pid --map-by ppr:7:node /reg/neh/operator/amoopr/amo86615/hummingbird/archive/amo86615/run.sh 
#`which mpirun` -tag-output -v -H daq-amo-mon03,daq-amo-mon02 --report-pid .pid --map-by ppr:11:node /reg/neh/operator/amoopr/amo86615/hummingbird/archive/amo86615/run.sh
